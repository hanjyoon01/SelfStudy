...
public class SearchDialog2 extends JDialog implements ActionListener{
	...
	//기본 다이얼로그 구현
	public SearchDialog2(MyFrame parent, String title, boolean modal) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand()=="검색") {
			...
			//검색 부분을 포함하는 모든 단어를 테이블에 출력
			for(int i=0;i<MyFrame.number;i++) {
				if(MyFrame.voc[i].getEng().contains(sWord)) {
